  ...
  <fieldset>
   ...
   <form id="formConsultaSaldo"> 
    <div class="controlgroup-vertical">
      ...
      <h2>Ingrese mes-año para la consulta:</h2>
      <input id="impFech" name="impFech" placeholder="10-2018" type="text-align:center">
...
<button id="btnConsultar" onclick="stopDefAction(event)"; >Consultar!</button>
	...
	<div id="progressbar"><div class="progress-label">Loading...</div>
	    ...
	    document.querySelector("#" + "RsltContenedor").className = "visibility";
			...
			$.post("src/controlador/ctrlDescargarPagos.php", data ,function(result) {	
